	...
	class BaseTest extends PHPUnit_Framework_TestCase {
		...
		public function getExpectedActualFunction() {
			$expAct = function($expectedActual) {
				return BaseTest::buildExpectedActualArgs($expectedActual['expected'], $expectedActual['actual']);
			};
		...
		public function getConfigurationMap() {
			return array(
				'test' => self::getTestConfiguration(),
			);
		}
		...
		public function getTestEntryPoint() {
			$test = $this;
			return array(
